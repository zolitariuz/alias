        <style type="text/css">
			...
			*/
			...
			.templateColumnContainer.alias_left{width:140px;}
			.templateColumnContainer.alias_left .leftColumnContent{ font-size:10px; padding-right: 30px; }



			.templateColumnContainer.alias_right{width:340px;}
			...
			*/
			...
			.rightColumnContent.text_right{ font-size: 12px; text-align: right; padding-left: 100px; display: block;}
                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                        <tr>
                                            <td valign="top" class="preheaderContent" mc:edit="preheader_content00">
                                               Antítesis / alias
                                            </td>
                                            <!-- *|IFNOT:ARCHIVE_PAGE|* -->
                                            <td valign="top" width="130" class="preheaderContent" mc:edit="preheader_content01">
                                               <a href="#">www.aliaseditorial.com</a>
                                            </td>
                                            <!-- *|END:IF|* -->
                                        </tr>
                                    </table>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                            	<img src="http://i1.wp.com/alias.tangentlabs.mx/wp-content/uploads/2013/09/Screen-Shot-2013-08-20-at-12.50.16-PM.png" style="max-width:600px;" id="headerImage" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END HEADER -->
                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateColumns">
                                    	<tr mc:repeatable>
                                        	<td align="center" valign="top" class="templateColumnContainer alias_left" style="padding-top:20px;">
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                	<tr>
                                                    	<td class="leftColumnContent">
                                                        	<img src="http://placehold.it/160x160" style="max-width:260px;" class="columnImage" mc:label="left_column_image" mc:edit="left_column_image" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        	...
                                        	<td align="center" valign="top" class="templateColumnContainer alias_right" style="padding-top:20px;">
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="rightColumnContent text_right" mc:edit="right_column_content">
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                    	<td valign="top" class="rightColumnContent" mc:edit="right_column_content">
															...
															<p>Utilitatis causa amicitia est quaesita. Sed quot homines, tot sententiae; Confecta res esset. Tu quidem reddes; Vos autem cum perspicuis dubia debeatis illustrare, dubiis perspicua conamini tollere. De vacuitate doloris eadem sententia erit. Nam si amitti vita beata potest, beata esse non potest.</p>

															<p>Age, inquies, ista parva sunt. Inde igitur, inquit, ordiendum est. Ille incendat? Et quod est munus, quod opus sapientiae? Tertium autem omnibus aut maximis rebus iis, quae secundum naturam sint, fruentem vivere.</p>
